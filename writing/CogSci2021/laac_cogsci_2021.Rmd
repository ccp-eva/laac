...
```{r metaplot, fig.env = "figure*", fig.pos = "h", fig.width=7, fig.height=1.5, fig.align = "center", set.cap.width=T, num.cols.cap=2, fig.cap = "Posterior distributions for Tau from the meta-analytic models for each task. Numbers denote mean and 95\\% HDI for Tau. Insets show the posterior distribution for the model intercept estimate at each time point."}
p_meta
```
