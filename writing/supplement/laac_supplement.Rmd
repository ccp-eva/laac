...
#                   age,
#                   time_in_leipzig),
#                 ~as.numeric(scale(., center = T, scale = F)))) %>%
...
```{r}
# proj_gaze_cv <- project(cvs_gaze,  solution_terms = c(1:8))
# 
...
```{r}
# proj_cau_cv_p2 <- project(cvs_cau_p2, solution_terms = c(1,2))
# 
...
```{r}
# proj_inf_cv_p2 <- project(cvs_inf_p2,  solution_terms = c(1, 2, 3))
# 
...
```{r}
# proj_gaze_cv_p2 <- project(cvs_gaze_p2,  solution_terms = c(1:4))
# 
...
```{r}
# proj_quant_cv_p2 <- project(cvs_quant_p2,  solution_terms = c(1:7))
# 
...
```{r}
# proj_grat_cv_p2 <- project(cvs_grat_p2,  solution_terms = c(1:5))
# 
