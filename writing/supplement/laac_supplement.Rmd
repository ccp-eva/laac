...
where $\kappa_{sit}$ denote threshold parameters [Manuel: Referenz hier einfügen:
...
[Manuel: Könnten wir in die Figure oben eine Note mit einfügen? Bitte in Figure Note anmerken: All factor loadings of the latent trait factor $T$ are fixed to 1 (not displayed in the figure).]
...
[Manuel: auch hier bitte folgenden Satz in einer figure Note mit einfügen? All factor loadings of the latent trait factor $T$ are fixed to 1 (not displayed in the figure).]
