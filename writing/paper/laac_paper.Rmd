...
Next, we investigated the structure of these individual differences. For this, we used structural equation modelling, in particular latent state-trait models with autoregressive effects (LST-AR) [@eid2017definition]. These models estimate latent variables which are assumed to be measurement-error free because they are estimated taking into account the reliability of the task. In the LSTM-AR context, reliability is the correlation between (measurement specific) test-halves. 
