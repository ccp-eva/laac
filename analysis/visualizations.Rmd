...
ggsave("../writing/paper/figures/latent_states_reliability.png", width = 10, height = 3, scale = 1.25, bg = "white")
```
...
```{r}
ggsave("../writing/paper/figures/reliability2.png", width = 10, height = 2.5, scale = 1.2, bg = "white")
```
...
```{r}
ggsave("../writing/paper/figures/structure.png", width = 16, height = 4.5, scale = 1, bg = "white")
```
